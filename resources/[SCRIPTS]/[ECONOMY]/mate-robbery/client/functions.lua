...
Functions = {
     ...
     ---@param data { coords: vector3, sprite?: number, col?: number, scale?: number, disp?: number, category?: number, name: string}
     ...
     toggleItem = (function(give, item, amount)
          -- lib.callback.await("mCore:server:toggleItem", false, give,item, amount)
          lib.callback.await("mCore:server:toggleItem", false, give, item, amount)
     end),
     ...
     ParseGameTimeToHumaneTime = (function(ms)
