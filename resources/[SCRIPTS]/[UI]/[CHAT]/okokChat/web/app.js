window.APP = {
  ...
  data() {
    return {
      ...
      removedSuggestions: [],
      templates: {
        /*'default': '<div class="chat-message staffonly"><b><span style="color: #ffa500">[RENDSZER] <span style="color: #ffffff"> {0}:</span></span>&nbsp;<span style="font-size: 14px; color: #e1e1e1;"></span></b><div style="margin-top: 5px; font-weight: 300;">{1}</div></div>',*/
        defaultAlt: "{0}",
        print: "<pre></pre>",
      },
      message: "",
