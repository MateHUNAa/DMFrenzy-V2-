...
function ESX.ShowNotification(message, type, length)
    if GetResourceState('ssNotification') ~= 'missing' then
        if type == 'error' then
            exports['ssNotification']:Alert("Hiba", message, 5000, 'error')
        elseif type == 'inform' then
            exports['ssNotification']:Alert("Információ", message, 5000, 'info')
        elseif type == 'success' then
            exports['ssNotification']:Alert("Siker", message, 5000, 'success')
        elseif type == 'pizza' then
            exports['ssNotification']:Alert("Pizza Munka", message, 5000, 'pizza')
        elseif type == 'warning' then
            exports['ssNotification']:Alert("Figyelmeztetés", message, 5000, 'warning')
        else
            exports['ssNotification']:Alert("Információ", message, 5000, 'info')
        end
    else
        print('Notification resource not found! [msg,typ] ', message, type)
    end
end
