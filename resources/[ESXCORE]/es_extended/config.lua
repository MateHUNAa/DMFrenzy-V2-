...
Config.Locale                    = (esxLocale ~= "invalid") and esxLocale or
    (txAdminLocale ~= "custom" and txAdminLocale) or "en"
...
Config.DefaultSpawns             = {     -- If you want to have more spawn positions and select them randomly uncomment commented code or add more locations
    { x = -1652.1383, y = -3142.1152, z = 13.9916, heading = 329.5274 },
...
Config.MaxWeight                 = 999       -- the max inventory weight without a backpack
